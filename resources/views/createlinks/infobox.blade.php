    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button id="sort-source" type="button" class="btn btn-tool sort-button" onclick="sortGraph('source')">Sort by Name</button>
            </div>
        </div>
        <div class="card-body">
            ...
            <div id="source" class="graph-container">
    ...
    <div class="card card-primary">
        <div class="card-header with-border">
            ...
            <div class="card-tools pull-right">
                <button id="sort-target" type="button" class="btn btn-tool sort-button" onclick="sortGraph('target')">Sort by Name</button>
            </div>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
