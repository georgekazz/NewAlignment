<script>
    ...
    $(document).ready(function(){
        sourceGraph("{{$_SESSION["source_json"]}}");
        targetGraph("{{$_SESSION["target_json"]}}");
    });

    // Toggle children.
    function sourceGraph(file){
    ...
    function checkConnectivityRight(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                setTimeout(checkConnectivityRight, 3000);
            }
        });
    }
</script>